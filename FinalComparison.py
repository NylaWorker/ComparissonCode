...
mat=JsonStampCounter(JArray[4],GroupIdArray[1])
...
#creates a csv file that compares both the teacher and my values. 
...
csvPrinter( stampComparator(jCountArray,MatTeach),'comp.csv')
